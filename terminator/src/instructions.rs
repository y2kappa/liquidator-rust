...
use crate::{
    consts::NULL_PUBKEY, liquidator::Liquidator, readable, utils::model::StateWithKey, writable,
};
...
pub fn liquidate_obligation_and_redeem_reserve_collateral_ix(
    ...
    let instruction = Instruction {
        ...
        data: kamino_lending::instruction::LiquidateObligationAndRedeemReserveCollateral {
            liquidity_amount,
            min_acceptable_received_collateral_amount: min_acceptable_received_coll_amount,
